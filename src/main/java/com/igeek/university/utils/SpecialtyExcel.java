...
public class SpecialtyExcel {
    public static void main(String[] args) {
        getData();
    }

    public static List<Specialty> getData() {
        List<Specialty> list = getAllByExcel("d.xlsx");
        return list;
    }

    public static List<Specialty> getAllByExcel(String file) {
        Workbook wb = null;
        Sheet sheet = null;
        Row row = null;
